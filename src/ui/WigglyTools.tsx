                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                  {PALETTE_PRESETS.map((p) => (
                    <button
                      ...
                      className={`flex flex-col p-2 rounded-[4px] border-[3px] transition-all relative overflow-hidden cursor-pointer ${JSON.stringify(palette) === JSON.stringify(p.colors)
                ...
                <div className="grid grid-cols-6 gap-2">
                  {BACKGROUND_COLOR_PRESETS.map((color) => (
                    <button
                      ...
                      className={`aspect-square rounded-[4px] border-[3px] transition-all relative flex items-center justify-center p-1 cursor-pointer ${backgroundColor === color
                ...
                <div className="grid grid-cols-6 gap-2">
                  {BODY_PRESETS.map((b) => (
                    <button
                      ...
                      className={`aspect-square rounded-[4px] border-[3px] transition-all relative flex items-center justify-center p-1 cursor-pointer ${JSON.stringify(bodyColor) === JSON.stringify(b.body)
                          ? "border-black bg-[#ffff00] shadow-[3px_3px_0_rgba(0,0,0,0.15)] z-10"
                          : "border-[#e7d1b1] bg-white hover:border-[#ff9d5c] shadow-[1px_1px_0_rgba(210,180,140,0.1)]"
                        }`}
                    >
