...
export function DesktopLayout({ canvas, tools, dsButtons }: LayoutProps) {
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[var(--color-zako-dark)] p-4 overflow-hidden font-sans text-slate-900">
      ...
      {/* Nintendo DSi風の本体 */}
      <div className="relative flex flex-col items-center gap-0 rounded-[3rem] bg-[var(--zako-body-bg)] shadow-[0_50px_100px_var(--color-zako-black-80),inset_0_-4px_10px_var(--color-zako-black-05),0_0_0_1px_var(--color-zako-black-10)] w-[650px] shrink-0 overflow-hidden border-b-[6px] border-[var(--zako-body-border)]">
        {/* 上部シェル */}
        <div className="w-full bg-[var(--zako-body-bg)] p-4 pt-6 pb-6 flex flex-col items-center relative">
          {/* スピーカー穴（左） */}
          ...
          {/* 上画面 */}
          <div className="relative w-full max-w-[420px] aspect-3/2 bg-[var(--zako-bezel-bg)] rounded-sm p-2 shadow-[inset_0_1px_8px_var(--color-zako-black-80)] border-[2px] border-[var(--zako-bezel-border)]">
            {/* 光沢スクリーン */}
        ...
        {/* ヒンジ部分 */}
        <div className="w-full h-10 bg-linear-to-b from-[var(--zako-hinge-from)] via-[var(--zako-hinge-via)] to-[var(--zako-hinge-to)] relative flex items-center justify-center border-y border-[var(--zako-hinge-border)] z-20">
          {/* ステータスLED（ヒンジ左側）- 装飾のみ */}
        ...
        {/* 下部シェル */}
        <div className="w-full bg-[var(--zako-body-bg)] p-4 pt-4 pb-6 flex items-center justify-center gap-2 relative border-t border-white/50">
          {/* 左: 十字キーと電源 */}
          <div className="flex flex-col items-end gap-6 -mt-2">
            <div className="relative w-[88px] h-[88px] flex items-center justify-center">
              {/* 十字キー台座（本体色に合わせ、影なし） */}
              <div className="absolute w-[110%] h-[110%] rounded-full bg-[var(--zako-body-bg)]" />
              ...
              >
                <div
                  className="w-full h-full bg-[var(--zako-button-bg)]"
                  style={{
                    clipPath:
            ...
            <div className="relative w-[88px] h-[88px] flex items-center justify-center">
              ...
              <div className="relative w-full h-full grid grid-cols-3 grid-rows-3 p-1">
                <button
                  ...
                  className="col-start-2 row-start-1 w-8 h-8 rounded-full bg-[var(--zako-button-bg)] border border-[var(--zako-button-border)] shadow-[0_2px_4px_var(--color-zako-black-10)] active:translate-y-px flex items-center justify-center font-bold text-xs text-[var(--zako-button-text)] cursor-pointer hover:brightness-110 transition-all"
                  aria-label="X"
                >
                  X
                </button>
                <button
                  ...
                  className="col-start-1 row-start-2 w-8 h-8 rounded-full bg-[var(--zako-button-bg)] border border-[var(--zako-button-border)] shadow-[0_2px_4px_var(--color-zako-black-10)] active:translate-y-px flex items-center justify-center font-bold text-xs text-[var(--zako-button-text)] cursor-pointer hover:brightness-110 transition-all"
                  aria-label="Y"
                >
                  Y
                </button>
                <button
                  ...
                  className="col-start-3 row-start-2 w-8 h-8 rounded-full bg-[var(--zako-button-bg)] border border-[var(--zako-button-border)] shadow-[0_2px_4px_var(--color-zako-black-10)] active:translate-y-px flex items-center justify-center font-bold text-xs text-[var(--zako-button-text)] cursor-pointer hover:brightness-110 transition-all"
                  aria-label="A"
                >
                  A
                </button>
                <button
                  ...
                  className="col-start-2 row-start-3 w-8 h-8 rounded-full bg-[var(--zako-button-bg)] border border-[var(--zako-button-border)] shadow-[0_2px_4px_var(--color-zako-black-10)] active:translate-y-px flex items-center justify-center font-bold text-xs text-[var(--zako-button-text)] cursor-pointer hover:brightness-110 transition-all"
                  aria-label="B"
                >
                  B
                </button>
